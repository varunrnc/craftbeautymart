                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <img src="{{asset('public/assets/images/product-imgs/estee.jpg')}}" alt="product imgs" class="img-fluid" width="100">
                        </td>
                        <td class="align-middle">My Product</td>
                        <td class="align-middle">Skin Care</td>
                        <td class="align-middle text-center">5</td>
                        <td class="align-middle">
                            <div class="form-check form-switch form-check-danger">
                                <input class="form-check-input" type="checkbox" role="switch" onclick="status(this.id)" id="" checked>
                            </div>
                        </td>
                        <td class="align-middle text-center">
                        <a href="#" id="" onclick="categoryDelete(this.id)">
                    ...
                    <td class="text-center">
                        <img src="{{ url('/') . '/' . $product->img->image }}" alt="product img" class="img-fluid border border-1 p-1" style="width: 100px; height: 130px">
                    </td>
                    ...
                    <td class="align-middle">
                        @if ($product->status == 1)
                        <div class="form-check form-switch form-check-danger">
                            <input class="form-check-input" type="checkbox" role="switch" onclick="status(this.id)" id="{{ $product->id }}" checked>
                        </div>
                        @else
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" role="switch" onclick="status(this.id)" id="{{ $product->id }}">
                        </div>
                        @endif
                    </td>
                    <td class="align-middle">
